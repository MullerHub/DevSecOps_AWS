...
## Print de como ficou as instancias e uma pequena parte dos logs do meu desenvolvimento (Tudo criado com AWS CLI)
...
## 4. Serviços de Monitoramento (CloudWatch ˜nao implementado˜ e Logs)
